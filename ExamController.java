...
public class ExamController extends JFrame implements ActionListener {
    ...
    public ExamController() {
        ...
        contentPanel.add(new JLabel());
        hallComboBox = new JComboBox<>(new String[]{"Hall1", "Hall2", "Hall3", "Hall4", "Hall5"});
        contentPanel.add(hallComboBox);
        showHallButton = new JButton("Show Hall");
    ...
    private void showHallResult(ResultSet resultSet) throws SQLException {
        resultFrame = new JFrame("Hall Details");
        resultFrame.setLayout(new BorderLayout());
    ...
    public static void main(String[] args) {
        ...
        examController.setVisible(true);
    }
}
